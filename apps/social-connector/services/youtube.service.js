/**
 * YouTube – fetch channel, video list, and analytics (views, likes, comments, watch time) via Data API v3 and Analytics API.
 */
...
/**
 * Get authenticated user's YouTube channel (we need channel ID for analytics).
 */
...
/**
 * Get videos (uploaded) for a channel.
 */
...
/**
 * Get analytics for a channel or for specific video IDs (views, likes, comments, estimatedMinutesWatched).
 */
...
/**
 * Aggregate: channel, video list, and per-video stats (views, likes, comments, watch time).
 */
