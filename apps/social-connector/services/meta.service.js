/**
 * Meta (Facebook + Instagram) – fetch post list and insights via Graph API.
 * Uses stored access_token; for Instagram Business we use Page → connected IG account.
 */
...
const instagramGraphBase = config.meta.instagramGraphBase;
...
/**
 * Get Facebook Pages for the user (required to get Instagram Business Account).
 */
...
/**
 * Get Instagram Business Account ID from a Page that has one connected.
 */
...
/**
 * Get media (posts) for an Instagram Business/Creator account.
 */
 ...
 * Metrics: likes, comments, impressions, reach (when available).
 */
...
/**
 * Aggregate: Instagram post list + insights (likes, comments, impressions, reach) per post.
 */
