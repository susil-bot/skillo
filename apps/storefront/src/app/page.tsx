    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="container mx-auto px-4 py-6">
                <p className="text-muted-foreground text-sm mb-2">Tenant stores:</p>
                <ul className="flex gap-4">
                    <li>
                        <a href="/t/susil" className="text-primary underline hover:no-underline font-medium">Susil</a>
                    </li>
                    <li>
                        <a href="/t/dev" className="text-primary underline hover:no-underline font-medium">Dev</a>
                    </li>
                </ul>
            </section>
            <FeaturedProducts/>
